 ...
 */
public class BaldFrameLayoutButton extends FrameLayout {
    ...
    public BaldFrameLayoutButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
