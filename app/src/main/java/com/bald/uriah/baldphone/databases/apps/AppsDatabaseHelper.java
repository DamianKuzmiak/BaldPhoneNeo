...
public class AppsDatabaseHelper {
    ...
    private static final Map<String, PredefinedAppInfo> PREDEFINED_APP_ICONS_MAP =
            Map.ofEntries(
                    ...
                    Map.entry(
                            PREDEFINED_APP_PREFIX + MediaActivity.class.getName(),
                            new PredefinedAppInfo(R.drawable.photo_on_background, R.string.photos)),
                    Map.entry(
                            PREDEFINED_APP_PREFIX + VIDEOS_ALIAS_CLASS,
     ...
     */
    public static void loadPic(App app, @NonNull ImageView imageView) {
        if (app == null) {
