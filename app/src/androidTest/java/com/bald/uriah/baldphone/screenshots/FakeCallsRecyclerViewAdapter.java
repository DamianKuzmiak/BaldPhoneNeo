...
public class FakeCallsRecyclerViewAdapter extends ModularRecyclerView.ModularAdapter<FakeCallsRecyclerViewAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setType(int type) {
            ...
            tv_type.setText(displayType.getStringRes());
            iv_type.setImageResource(displayType.getDrawableRes());
            tv_type.setTextColor(ContextCompat.getColor(activity, displayType.getColorRes()));
            iv_type.setBackgroundResource(displayType.getColorRes());
        }
    }
}
